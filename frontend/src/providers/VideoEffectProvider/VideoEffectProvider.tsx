...
export type VirtualBackgroundQuality = 0 | 1 | 2 | 3 | 4 | 5 | 6;
const VirtualBackgroundQualityOptions:VirtualBackgroundQuality[] = [0, 1, 2, 3, 4, 5, 6];
export const VirtualBackgroundQualityResolution = [300, 450, 600, 750, 900, 1050, 1200]
